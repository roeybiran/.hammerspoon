...
local function clickOnHistoryMenuItem(appObj) appObj:selectMenuItem({"History"}) end
...
local functions = {
  ...
  clickOnHistoryMenuItem = function() clickOnHistoryMenuItem(_appObj) end,
  toggleBookmarks = function() toggleBookmarks(_appObj) end
